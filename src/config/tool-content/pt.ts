...
export const toolContentPt: Record<string, ToolContent> = {
  ...
  'add-watermark': {
    title: 'Add Watermark',
    metaDescription: `Adicione marca d'água online gratuitamente - sem registro, sem inscrição. `,
    keywords: [
  ...
  'remove-watermark': {
    ...
    metaDescription: `Remova a marca d'água online gratuitamente - sem registro, sem inscrição. `,
    keywords: [
