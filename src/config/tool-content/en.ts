...
export const toolContentEn: Record<string, ToolContent> = {
  ...
  'djvu-to-pdf': {
    title: 'DJVU to PDF',
    metaDescription: 'Convert DJVU to PDF free online - no registration, no sign-up. Process your DJVU files securely in your browser. Use our free online tool to convert DJVU to PDF quickly.',
    keywords: [
      'djvu to pdf free online',
      'djvu to pdf no registration',
      'djvu to pdf no sign up',
      'djvu to pdf no watermark',
      'djvu to pdf browser based',
      'djvu to pdf for work',
      'djvu to pdf for students',
      'best djvu to pdf converter',
      'how to convert djvu to pdf',
      'djvu to pdf online free',
      'djvu to pdf without software',
      'djvu to pdf privacy focused',
      'djvu to pdf secure',
      'djvu to pdf fast',
      'free djvu to pdf converter',
      'online djvu to pdf free',
      'djvu to pdf tool online',
      'djvu to pdf for free',
      'djvu to pdf no download',
      'djvu to pdf web based',
      'djvu to pdf open source',
      'djvu to pdf wasm',
      'djvu to pdf client side',
      'djvu to pdf no upload',
      'djvu to pdf instant',
      'djvu to pdf high quality',
      'djvu to pdf no limit',
      'djvu to pdf 2025',
      'djvu to pdf guide',
      'djvu to pdf tutorial',
    ],
    description: `
      <p>Convert DJVU to PDF free online with our powerful browser-based tool. Whether you need to convert DJVU to PDF for personal or professional use, our free online tool provides a fast, secure solution.</p>
            <p>Simply upload your DJVU files, adjust the settings, and process your documents in seconds. All processing happens locally in your browser, ensuring complete privacy.</p>
            <p>You can convert DJVU to PDF no registration required, with no watermarks added. How to convert DJVU to PDF for free? Use our online tool—no software needed.</p>
            <p>Converting DJVU to PDF has never been easier. Get started now with the best free DJVU to PDF tool online.</p>
    `,
    howToUse: [
      { step: 1, title: 'Upload Your DJVU File', description: 'Click the upload area or drag and drop your DJVU file. All files are processed locally in your browser, ensuring complete privacy. You can convert DJVU to PDF no registration, no sign-up needed.' },
      { step: 2, title: 'Configure Settings', description: 'Adjust DPI and quality settings to match your needs. The interface is intuitive and requires no learning curve. Our free DJVU to PDF tool gives you full control.' },
      { step: 3, title: 'Convert and Download', description: 'Click the convert button and wait a few seconds. Once finished, download your PDF file instantly. No email required, no watermarks.' },
    ],
    useCases: [
      { title: 'For Researchers', description: 'Researchers convert scanned DJVU books and papers to PDF for easier sharing and citation. Browser-based processing ensures sensitive documents never leave your device.', icon: 'briefcase' },
      { title: 'For Students', description: 'Students frequently need to convert DJVU textbooks and references to PDF. Our free tool helps without paying for expensive software subscriptions.', icon: 'academic-cap' },
      { title: 'For Personal Use', description: 'Anyone with DJVU archives can use our tool to convert them to PDF for modern readers. The simple interface makes it accessible to users of all technical levels.', icon: 'user' },
    ],
    faq: [
      { question: 'Is it really free to convert DJVU to PDF online?', answer: 'Yes, our DJVU to PDF tool is completely free to use. No registration, no sign-up, no credit card required. You can convert DJVU to PDF as many times as you need.' },
      { question: 'Is it safe to convert DJVU to PDF online?', answer: 'Absolutely. All DJVU to PDF processing happens locally in your browser. Your files never leave your device and are never uploaded to any server.' },
      { question: 'Do I need to install software to convert DJVU to PDF?', answer: 'No software installation is required. Our DJVU to PDF tool runs entirely in your web browser. It works on Windows, Mac, Linux, and mobile devices.' },
      { question: 'Are there any limits on file size or number of files?', answer: 'Our tool supports processing files with a combined size of up to 500MB. There are no daily usage limits or paywalls.' },
      { question: 'Will the output quality be affected?', answer: 'Our tool is designed to maintain the highest possible quality. You can choose DPI and quality settings to balance file size and fidelity.' },
    ],
  },
  'fb2-to-pdf': {
    title: 'FB2 to PDF',
    metaDescription: 'Convert FB2 to PDF free online - no registration, no sign-up. Process your FB2 ebooks securely in your browser. Use our free online tool to convert FB2 to PDF quickly.',
    keywords: [
      'fb2 to pdf free online',
      'fb2 to pdf no registration',
      'fb2 to pdf no sign up',
      'fb2 to pdf no watermark',
      'fb2 to pdf browser based',
      'fb2 to pdf for work',
      'fb2 to pdf for students',
      'best fb2 to pdf converter',
      'how to convert fb2 to pdf',
      'fb2 to pdf online free',
      'fb2 to pdf without software',
      'fb2 to pdf privacy focused',
      'fb2 to pdf secure',
      'fb2 to pdf fast',
      'free fb2 to pdf converter',
      'online fb2 to pdf free',
      'fb2 to pdf tool online',
      'fb2 to pdf for free',
      'fb2 to pdf no download',
      'fb2 to pdf web based',
      'fb2 to pdf open source',
      'fb2 to pdf wasm',
      'fb2 to pdf client side',
      'fb2 to pdf no upload',
      'fb2 to pdf instant',
      'fb2 to pdf high quality',
      'fb2 to pdf no limit',
      'fb2 to pdf 2025',
      'fb2 to pdf guide',
      'fb2 to pdf tutorial',
    ...
    description: `
      <p>Convert FB2 to PDF free online with our powerful browser-based tool. Whether you need to convert FB2 ebooks to PDF for personal or professional use, our free online tool provides a fast, secure solution.</p>
            <p>Simply upload your FB2 files, adjust the settings, and process your documents in seconds. All processing happens locally in your browser, ensuring complete privacy.</p>
            <p>You can convert FB2 to PDF no registration required, with no watermarks added. How to convert FB2 to PDF for free? Use our online tool—no software needed.</p>
            <p>Converting FB2 to PDF has never been easier. Get started now with the best free FB2 to PDF tool online.</p>
    `,
    howToUse: [
      { step: 1, title: 'Upload Your FB2 File', description: 'Click the upload area or drag and drop your FB2 or .fb2.zip file. All files are processed locally in your browser, ensuring complete privacy. You can convert FB2 to PDF no registration, no sign-up needed.' },
      { step: 2, title: 'Configure Settings', description: 'Adjust formatting, image, and chapter structure options to match your needs. The interface is intuitive and requires no learning curve. Our free FB2 to PDF tool gives you full control.' },
      { step: 3, title: 'Convert and Download', description: 'Click the convert button and wait a few seconds. Once finished, download your PDF file instantly. No email required, no watermarks.' },
    ],
    useCases: [
      { title: 'For Readers', description: 'Readers convert FB2 ebooks to PDF for use on devices that do not support FB2 natively. Browser-based processing ensures your library never leaves your device.', icon: 'briefcase' },
      { title: 'For Students', description: 'Students convert FB2 references and study materials to PDF for annotation and printing. Our free tool helps without paying for expensive software subscriptions.', icon: 'academic-cap' },
      { title: 'For Personal Use', description: 'Anyone with FB2 collections can use our tool to convert them to PDF, preserving images and chapter structure. The simple interface makes it accessible to users of all technical levels.', icon: 'user' },
    ],
    faq: [
      { question: 'Is it really free to convert FB2 to PDF online?', answer: 'Yes, our FB2 to PDF tool is completely free to use. No registration, no sign-up, no credit card required. You can convert FB2 to PDF as many times as you need.' },
      { question: 'Is it safe to convert FB2 to PDF online?', answer: 'Absolutely. All FB2 to PDF processing happens locally in your browser. Your files never leave your device and are never uploaded to any server.' },
      { question: 'Do I need to install software to convert FB2 to PDF?', answer: 'No software installation is required. Our FB2 to PDF tool runs entirely in your web browser. It works on Windows, Mac, Linux, and mobile devices.' },
      { question: 'Are there any limits on file size or number of files?', answer: 'Our tool supports processing multiple FB2 files with a combined size of up to 500MB. There are no daily usage limits or paywalls.' },
      { question: 'Will images and formatting be preserved?', answer: 'Yes. Our tool preserves embedded images, formatting, and chapter structure to keep the converted PDF as faithful to the original FB2 as possible.' },
    ],
  },
  'markdown-to-pdf': {
    title: 'Markdown to PDF',
    metaDescription: 'Convert Markdown to PDF free online - no registration, no sign-up. Render Markdown securely in your browser. Use our free online tool to convert Markdown to PDF quickly.',
    keywords: [
      'markdown to pdf free online',
      'markdown to pdf no registration',
      'markdown to pdf no sign up',
      'markdown to pdf no watermark',
      'markdown to pdf browser based',
      'markdown to pdf for work',
      ...
      'markdown to pdf privacy focused',
      'markdown to pdf secure',
      'markdown to pdf fast',
      'free markdown to pdf converter',
      'online markdown to pdf free',
      'markdown to pdf tool online',
      'markdown to pdf for free',
      'markdown to pdf no download',
      'markdown to pdf web based',
      'markdown to pdf open source',
      'markdown to pdf wasm',
      'markdown to pdf client side',
      'markdown to pdf no upload',
      'markdown to pdf instant',
      'markdown to pdf high quality',
      'markdown to pdf no limit',
      'markdown to pdf 2025',
      'markdown to pdf guide',
      'markdown to pdf tutorial',
    ],
    description: `
      <p>Convert Markdown to PDF free online with our powerful browser-based tool. Whether you need to convert Markdown documents to PDF for personal or professional use, our free online tool provides a fast, secure solution.</p>
            <p>Simply upload your .md or .markdown files, choose a theme, and render in seconds. All processing happens locally in your browser, ensuring complete privacy.</p>
            <p>You can convert Markdown to PDF no registration required, with no watermarks added. How to convert Markdown to PDF for free? Use our online tool—no software needed.</p>
            <p>Converting Markdown to PDF has never been easier. CommonMark, GFM tables, and code highlighting are supported out of the box.</p>
    `,
    howToUse: [
      { step: 1, title: 'Upload Your Markdown File', description: 'Click the upload area or drag and drop your .md, .markdown, or .txt files. All files are processed locally in your browser, ensuring complete privacy. You can convert Markdown to PDF no registration, no sign-up needed.' },
      { step: 2, title: 'Choose a Theme', description: 'Pick a built-in theme and toggle GFM tables and code highlighting to match your needs. The interface is intuitive and requires no learning curve.' },
      { step: 3, title: 'Convert and Download', description: 'Click the convert button and wait a few seconds. Once finished, download your PDF file instantly. No email required, no watermarks.' },
    ],
    useCases: [
      { title: 'For Developers', description: 'Developers convert README, API docs, and changelogs from Markdown to PDF for sharing with stakeholders. Browser-based processing keeps internal docs private.', icon: 'briefcase' },
      { title: 'For Students', description: 'Students convert Markdown notes and assignments to PDF for submission and printing. Our free tool helps without paying for expensive software subscriptions.', icon: 'academic-cap' },
      { title: 'For Personal Use', description: 'Anyone writing in Markdown can use our tool to share documents as PDF with consistent formatting. The simple interface makes it accessible to users of all technical levels.', icon: 'user' },
    ],
    faq: [
      { question: 'Is it really free to convert Markdown to PDF online?', answer: 'Yes, our Markdown to PDF tool is completely free to use. No registration, no sign-up, no credit card required. You can convert Markdown to PDF as many times as you need.' },
      { question: 'Is it safe to convert Markdown to PDF online?', answer: 'Absolutely. All Markdown to PDF processing happens locally in your browser. Your files never leave your device and are never uploaded to any server.' },
      { question: 'Which Markdown flavors are supported?', answer: 'We support CommonMark and GitHub Flavored Markdown (GFM), including tables, task lists, and fenced code blocks with syntax highlighting.' },
      { question: 'Are there any limits on file size or number of files?', answer: 'Our tool supports processing multiple Markdown files with a combined size of up to 500MB. There are no daily usage limits or paywalls.' },
      { question: 'Can I customize the output style?', answer: 'Yes. You can choose from built-in themes and toggle code highlighting and GFM tables to control how your PDF looks.' },
    ],
  },
  'xps-to-pdf': {
    title: 'XPS to PDF',
    metaDescription: 'Convert XPS to PDF free online - no registration, no sign-up. Process your XPS files securely in your browser. Use our free online tool to convert XPS to PDF quickly.',
    keywords: [
      'xps to pdf free online',
      'xps to pdf no registration',
      'xps to pdf no sign up',
      'xps to pdf no watermark',
      'xps to pdf browser based',
      'xps to pdf for work',
      'xps to pdf for students',
      'best xps to pdf converter',
      'how to convert xps to pdf',
      'xps to pdf online free',
      'xps to pdf without software',
      'xps to pdf privacy focused',
      'xps to pdf secure',
      'xps to pdf fast',
      'free xps to pdf converter',
      'online xps to pdf free',
      'xps to pdf tool online',
      'xps to pdf for free',
      'xps to pdf no download',
      'xps to pdf web based',
      'xps to pdf open source',
      'xps to pdf wasm',
      'xps to pdf client side',
      'xps to pdf no upload',
      'xps to pdf instant',
      'xps to pdf high quality',
      'xps to pdf no limit',
      'xps to pdf 2025',
      'xps to pdf guide',
      'xps to pdf tutorial',
    ...
    description: `
      <p>Convert XPS to PDF free online with our powerful browser-based tool. Whether you need to convert XPS documents to PDF for personal or professional use, our free online tool provides a fast, secure solution.</p>
            <p>Simply upload your .xps file, adjust the settings, and process your document in seconds. All processing happens locally in your browser, ensuring complete privacy.</p>
            <p>You can convert XPS to PDF no registration required, with no watermarks added. How to convert XPS to PDF for free? Use our online tool—no software needed.</p>
            <p>Converting XPS to PDF has never been easier. Layout, vector graphics, and text are preserved with high fidelity.</p>
    `,
    howToUse: [
      { step: 1, title: 'Upload Your XPS File', description: 'Click the upload area or drag and drop your .xps file. All files are processed locally in your browser, ensuring complete privacy. You can convert XPS to PDF no registration, no sign-up needed.' },
      { step: 2, title: 'Configure Settings', description: 'Adjust layout and quality settings to match your needs. The interface is intuitive and requires no learning curve. Our free XPS to PDF tool gives you full control.' },
      { step: 3, title: 'Convert and Download', description: 'Click the convert button and wait a few seconds. Once finished, download your PDF file instantly. No email required, no watermarks.' },
    ],
    useCases: [
      { title: 'For Office Work', description: 'Professionals convert XPS exports from legacy Windows tools to PDF for portability across platforms. Browser-based processing keeps sensitive documents private.', icon: 'briefcase' },
      { title: 'For Students', description: 'Students convert XPS lecture notes and assignments to PDF for easier reading on any device. Our free tool helps without paying for expensive software subscriptions.', icon: 'academic-cap' },
      { title: 'For Personal Use', description: 'Anyone with old XPS files can convert them to PDF for long-term archiving. The simple interface makes it accessible to users of all technical levels.', icon: 'user' },
    ],
    faq: [
      { question: 'Is it really free to convert XPS to PDF online?', answer: 'Yes, our XPS to PDF tool is completely free to use. No registration, no sign-up, no credit card required. You can convert XPS to PDF as many times as you need.' },
      { question: 'Is it safe to convert XPS to PDF online?', answer: 'Absolutely. All XPS to PDF processing happens locally in your browser. Your files never leave your device and are never uploaded to any server.' },
      { question: 'Do I need to install software to convert XPS to PDF?', answer: 'No software installation is required. Our XPS to PDF tool runs entirely in your web browser. It works on Windows, Mac, Linux, and mobile devices.' },
      { question: 'Are there any limits on file size?', answer: 'Our tool supports XPS files of up to 500MB. There are no daily usage limits or paywalls.' },
      { question: 'Will the layout and vectors be preserved?', answer: 'Yes. Our tool preserves layout, vector graphics, and text with high fidelity, so the resulting PDF closely matches the source XPS.' },
    ],
  },
};